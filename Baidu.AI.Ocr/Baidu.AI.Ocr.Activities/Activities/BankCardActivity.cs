...
{
    [LocalizedDisplayName(nameof(Resources.BankCardActivityDisplayName))]
    [LocalizedDescription(nameof(Resources.BankCardActivityDescription))]
    public class BankCardActivity : BaiduOcrActivityBase
    {
