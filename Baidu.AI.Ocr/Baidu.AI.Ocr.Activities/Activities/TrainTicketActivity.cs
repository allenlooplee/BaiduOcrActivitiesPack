...
{
    [LocalizedDisplayName(nameof(Resources.TrainTicketActivityDisplayName))]
    [LocalizedDescription(nameof(Resources.TrainTicketActivityDescription))]
    public class TrainTicketActivity : BaiduOcrActivityBase
    {
        ...
        {
            return Task.Run(() => baiduOcr.TrainTicket(image));
        }
    }
}
